...
class lib_pagination{
   ...
   function __construct() {
    ...
    function create_pagination($pg_config) {
        ...
        $data["result_total"] = $config["total_rows"];
        $data["totalrecord"] = $pg_config['totalrecord'];
        $data["resultname"] = $pg_config['resultname'];
        $data["showresultperpage"] = $pg_config['per_page'];
        return $data;
    }
